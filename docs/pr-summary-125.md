...
- **28 new unit tests** across 3 test files + 3 config tests for `ALLOWED_SNAPSHOT_ORIGINS`
...
- `tests/sw_static_files_test.ts` — existing tests verify new modules are in SW cache
