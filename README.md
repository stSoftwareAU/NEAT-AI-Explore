...
| `docs/shared/ui_helpers.js`          | `escapeHtml`                                                                                                                              |
| `docs/shared/creature_normaliser.js` | `normaliseCreature`                                                                                                                       |
| `docs/shared/alias_registry.js`      | `buildAliasRegistry`, `getAlias`, `getDescription`, `getGroup`                                                                            |
